import sys
sys.path.insert(0,'C:/Users/T/Desktop/python/计算机视觉/Opencv教程/目标检测与识别/car_detector/')
...
img_path='C:\\Users\\T\\Downloads\\22.jpg'
...
for resized in pyramid(img, scaleFactor):
    ...
    print(resized.shape)
    for (x, y, roi) in sliding_window(resized, 20, (500, 200)):
